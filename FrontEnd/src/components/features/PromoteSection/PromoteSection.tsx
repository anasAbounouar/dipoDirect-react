  ...
  return (
    ...
    <section id="promote" className={`py-5 `}>
      ...
      <div className="flex justify-center">
        ...
        <h2 className="text-myBrand text-3xl p-3">شري بالرباح ونت مرتاح</h2>
      </div>
      ...
      <div className="container mx-auto pb-4">
        <div className="flex flex-wrap flex-row mt-5 mb-4 gap-4 justify-center">
          ...
          {Array.from({ length: 3 }, (_, index) => (
            <div className="w-full lg:w-1/4 mx-3 mt-3 gap-4" key={index}>
      ...
      <div className="flex mt-5 items-center justify-center bg-blue-500 p-6">
        <p className="m-0 px-2.5 py-1 text-white text-xl">
