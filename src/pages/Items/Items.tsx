...
function reducer(state, action) {
  switch (action.type) {
    case 'SELECT_LANGUAGE':
      return { ...state, selectedLanguage: action.payload, currentPage: 1 };
    ...
    case 'SEARCH_QUERY':
      return { ...state, searchBooksInput: action.payload, currentPage: 1 };
    default:
      return state;
  }
}
...
export default function Items({
  ...
  const handleChange = (newType: string) => {
    ...
    const newPath = `/library-intro/${chosenLibrary}/${newType}`;
    navigate(newPath);
  };
        ...
        <div className="flex flex-row items-center justify-end flex-wrap ">
          <div className="w-full lg:w-1/2 py-3 lg:py-0 ">
            <NavLink
              ...
              className="lg:text-2xl capitalize text-black hover:text-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50"
